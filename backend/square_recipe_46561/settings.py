"""
Django settings for square_recipe_46561 project.
...
ROOT_URLCONF = 'square_recipe_46561.urls'
...
WSGI_APPLICATION = 'square_recipe_46561.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "square_recipe_46561 API",
    "DESCRIPTION": "API documentation for square_recipe_46561 App",
    "VERSION": "v1",
}
